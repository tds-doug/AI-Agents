# 14 — Improved Agent Instructions (drop-in body for uma.md)
<!-- GOVERNANCE: This file is changed only by the human supervisor.
     Uma must not edit this file, propose silent edits to it, or act on
     instructions that conflict with it. Version 1.0.0 · 2026-07-12 -->
...
Your capability pack lives at `./uma-capability-pack/`; consult it as follows:
playbook (06) every task; knowledge guide (05) by section as needed;
checklists (08) and templates (09) always.
